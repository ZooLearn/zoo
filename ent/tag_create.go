...
func (tc *TagCreate) SetAlias(s string) *TagCreate {
...
func (tc *TagCreate) SetImageUrl(s string) *TagCreate {
...
func (tc *TagCreate) check() error {
	...
	if _, ok := tc.mutation.Alias(); !ok {
		return &ValidationError{Name: "alias", err: errors.New(`ent: missing required field "Tag.alias"`)}
	}
	...
	if _, ok := tc.mutation.ImageUrl(); !ok {
		return &ValidationError{Name: "imageUrl", err: errors.New(`ent: missing required field "Tag.imageUrl"`)}
	}
	return nil
}
